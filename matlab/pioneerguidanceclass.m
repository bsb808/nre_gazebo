classdef pioneerguidanceclass < handle
   properties
   ...
   methods
      ...
      function geonav_callback(obj,src,msg)
          ...
          %obj.drive2waypoint(obj.x_geonav,obj.y_geonav,obj.xth_geonav);
          % Line following guidance
          obj.los(obj.x_geonav,obj.y_geonav,obj.th_geonav);
      ...
      function los(obj,x,y,th)
          if ( (obj.wpt_index == 0) || (obj.wpt_index > (size(obj.waypoints,1)-1)) )
              obj.publish_cmd_vel(0,0);
          else
              x_start = obj.waypoints(obj.wpt_index,1);
      ...
      % Drive to the current waypoint  the given position estimate
