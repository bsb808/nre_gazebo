...
class Node():
    def __init__(self,olat,olong):
        ...
        self.statusmsg = Int16MultiArray()
        self.statuspub = rospy.Publisher("nav/status",Int16MultiArray,queue_size=10)
    ...
    def publishodom(self):
        if self.rxodom:
            ...
            self.statusmsg.data=[2,1,0]
            self.statuspub.publish(self.statusmsg)
